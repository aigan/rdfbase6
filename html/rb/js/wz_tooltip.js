...
config. BgColor 	= 'gray' 	// Background color
...
config. Delay		= 0.2		// Time span in ms until tooltip shows up
config. Duration	= 1500 		// Time span in ms after which the tooltip disappears; 0 for infinite duration
